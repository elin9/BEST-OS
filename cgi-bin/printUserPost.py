...
# 	print '<form id = "delete" action = "deletePost.py">'
	print '<input type = hidden name = "user" value = %s>' %row[0]
	print '<input class="check" type="checkbox" value=\'%s\'>select</input>' %row[1]
